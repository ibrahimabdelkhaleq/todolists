      ...
      context "Generate four(4) Model Classes and Properties" do
        context "rq02.1 User Model" do
          ...
          it "User database structure in place" do
            ...
            expect(User.attribute_types["username"].type).to eq :string
            expect(User.attribute_types["password_digest"].type).to eq :string
        ...
        context "rq02.2 Profile Model" do
          ...
          it "Profile database structure in place" do
            ...
            expect(Profile.attribute_types["gender"].type).to eq :string
            expect(Profile.attribute_types["birth_year"].type).to eq :integer
            expect(Profile.attribute_types["first_name"].type).to eq :string
            expect(Profile.attribute_types["last_name"].type).to eq :string
            expect(User.attribute_types["created_at"].type).to eq :datetime
            expect(User.attribute_types["updated_at"].type).to eq :datetime
          end
        end
        context "rq02.3 TodoList Model" do
          ...
          it "TodoList database structure in place" do
            ...
            expect(TodoList.attribute_types["list_name"].type).to eq :string
            expect(TodoList.attribute_types["list_due_date"].type).to eq :date
            expect(TodoList.attribute_types["created_at"].type).to eq :datetime
            expect(TodoList.attribute_types["updated_at"].type).to eq :datetime
          end
        end
        context "rq02.4 TodoItem Model" do
          ...
          it "TodoItem database structure in place" do
            ...
            expect(TodoItem.attribute_types["due_date"].type).to eq :date
            expect(TodoItem.attribute_types["title"].type).to eq :string
            expect(TodoItem.attribute_types["description"].type).to eq :text
            expect(TodoItem.attribute_types["completed"].type).to eq :boolean
            expect(TodoItem.attribute_types["created_at"].type).to eq :datetime
            expect(TodoItem.attribute_types["updated_at"].type).to eq :datetime
          end
        end
      end
    end
